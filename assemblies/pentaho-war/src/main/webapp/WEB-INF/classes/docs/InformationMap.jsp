...
$('document').ready(function(){
   ...
   var docBase = "https://help.pentaho.com/Documentation/9.3/";
  ...
  <div class="pentaho-rounded-panel2-shadowed pentaho-background pentaho-shine">
    <div id="banner">
      <table width="700" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td valign="top" class="bannercontent"><%=Messages.getInstance().getString("UI.PUC.DOCS.HEADER.VISIT_INFO", "<a href=\"https://help.pentaho.com/Documentation/9.3\" target=\"_blank\">Pentaho InfoCenter</a>")%><br /></td>
        </tr>
      </table>
    </div>
